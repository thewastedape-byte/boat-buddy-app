    ...
    <div className="bg-wood min-h-screen flex flex-col">
      ...
      <header className="flex items-center justify-between px-4 py-3 sticky top-0 z-40"
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs hidden sm:block" style={{ color: 'rgba(245,240,232,0.82)', fontFamily: 'Georgia, serif' }}>
      ...
      {serviceAlert && (
        <div className="px-4 py-2 flex items-center justify-between gap-3"
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button onClick={() => setServiceAlert(null)} className="text-xs" style={{ color: 'rgba(245,240,232,0.82)', background: 'none', border: 'none', cursor: 'pointer' }}>?</button>
          </div>
        </div>
      )}
          ...
          <div style={{ background: '#1a0e05', border: '1px solid rgba(198,139,58,0.5)', borderRadius: '16px', padding: '32px 24px', maxWidth: '380px', width: '100%', textAlign: 'center' }}>
            ...
            <div style={{ background: 'rgba(198,139,58,0.1)', border: '1px solid rgba(198,139,58,0.3)', borderRadius: '10px', padding: '16px', marginBottom: '20px' }}>
              ...
              <p style={{ color: '#F5F0E8', fontWeight: 'bold', fontSize: '20px', marginTop: '8px' }}>
                $4.99<span style={{ fontSize: '13px', color: 'rgba(245,240,232,0.82)', fontWeight: 'normal' }}>/mo</span>{' '}
            ...
            <div className="mb-3" style={{ background: 'rgba(20,8,2,0.92)', border: '1px solid rgba(198,139,58,0.4)', borderRadius: '10px', overflow: 'hidden' }}>
              <div className="flex items-center justify-between px-3 py-2" style={{ borderBottom: '1px solid rgba(198,139,58,0.2)' }}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setInlineDiagram(null)} style={{ color: 'rgba(245,240,232,0.78)', background: 'none', border: 'none', cursor: 'pointer', fontSize: '14px' }}>?</button>
                </div>
              </div>

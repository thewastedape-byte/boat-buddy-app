      ...
      <main className="flex-1 overflow-y-auto px-4 py-6 pb-28">
        <div className="max-w-sm mx-auto">
          ...
          <div className="panel p-4 mb-4">
            ...
            <p className="text-xs mt-3" style={{ color: 'rgba(245,240,232,0.78)', fontFamily: 'Georgia, serif' }}>
          ...
          <div className="panel p-4 mb-6">
            ...
            <div className="p-3 rounded-lg mb-4" style={{ background: 'rgba(198,139,58,0.1)', border: '1px solid rgba(198,139,58,0.3)' }}>
              <p className="text-xs mb-1" style={{ color: 'rgba(245,240,232,0.82)', fontFamily: 'Georgia, serif' }}>Send to:</p>
              <p className="text-sm font-bold" style={{ color: '#C68B3A', fontFamily: 'Georgia, serif' }}>thewastedape@gmail.com</p>
              <p className="text-xs mt-2" style={{ color: 'rgba(245,240,232,0.82)', fontFamily: 'Georgia, serif' }}>Subject: Cancel Subscription</p>
              <p className="text-xs mt-1" style={{ color: 'rgba(245,240,232,0.82)', fontFamily: 'Georgia, serif' }}>Include your account email address.</p>
            </div>
